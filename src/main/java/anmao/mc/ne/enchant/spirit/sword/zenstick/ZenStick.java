package anmao.mc.ne.enchant.spirit.sword.zenstick;
...
public class ZenStick extends SSE {
    private static final MobEffectInstance YanLing = new MobEffectInstance(Effects.YAN_LING.getHolder().get(),1,200);
